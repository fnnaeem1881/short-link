...
@yield('header_nav')
                        ...
                        <ul class="nav-right">
                                ...
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius"
                                                    src="{{asset('frontend/assets')}}/images/avatar-4.jpg"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius"
                                                    src="{{asset('frontend/assets')}}/images/avatar-3.jpg"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{asset('frontend/assets')}}/images/avatar-4.jpg" class="img-radius"
                        ...
                        <div class="user-box">
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box" data-id="1" data-status="online"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius"
                                            src="{{asset('frontend/assets')}}/images/avatar-3.jpg" alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box" data-id="2" data-status="online"
                                    ...
                                    title="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('frontend/assets')}}/images/avatar-2.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('frontend/assets')}}/images/avatar-4.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('frontend/assets')}}/images/avatar-3.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
            ...
            <div class="showChat_inner">
                ...
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="{{asset('frontend/assets')}}/images/avatar-3.jpg"
                            alt="Generic placeholder image">
                    </a>
                    ...
                    <div class="media-right photo-table">
                        <a href="#!">
                            <img class="media-object img-radius img-radius m-t-5"
                                src="{{asset('frontend/assets')}}/images/avatar-4.jpg" alt="Generic placeholder image">
                        </a>
                    </div>
                </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class=" ">
                                    <a href="{{route('home')}}">
                                        ...
                                        <span class="pcoded-mtext">Back To Website</span>
                                    </a>
                                </li>
@yield('sidebar_nav')
...
{{-- Validation  js --}}
<script type="text/javascript" src="{{asset('frontend/assets')}}/validation/moment.min.js"></script>
<script type="text/javascript" src="{{asset('frontend/assets')}}/validation/underscore-min.js"></script>
<script type="text/javascript" src="{{asset('frontend/assets')}}/validation/validate.js"></script>
    <!-- amchart js -->
